  ...
  return (
    <div className="p-8 space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-2xl font-black text-slate-900 dark:text-white">Comunidades</h2>
          <p className="text-slate-500 text-sm">Células e Grupos da {selectedIgreja?.nome || 'igreja'}</p>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm p-8 text-center text-slate-500">
        Módulo de Comunidades em desenvolvimento...
      </div>
    </div>
  );
}
